...
def airports_file(tmp_path):
    rows = [
        ...
        '4,"Nadzab Airport","Nadzab","Papua New Guinea","\N","AYNZ",-6.569803,146.725977,239,10,"U","Pacific/Port_Moresby","airport","OurAirports"',
        '5,"Port Moresby Jacksons International Airport","Port Moresby","Papua New Guinea","POM","\N",-9.443380355834961,147.22000122070312,146,10,"U","Pacific/Port_Moresby","airport","OurAirports"'
    ]
